...
export default function RegisterPage() {
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    role: 'STORE_KEEPER' as 'MANAGER' | 'STORE_KEEPER'
  });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#0f0f0f] py-12 px-4 sm:px-6 lg:px-8">
